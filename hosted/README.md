...
## کتابخانه تصویری
۲۸ ماده دسته‌بندی‌شده با نماد تصویری، جست‌وجو، ثبت سه‌مرحله‌ای و پنج رسپی پیشنهادی. اندازه بسته پیشنهادی است؛ قیمت ساختگی وارد نمی‌شود. تطبیق الگو با مواد ذخیره‌شده بر اساس شناسه کتابخانه یا نام دقیق و واحد یکسان انجام می‌شود. مواد ناموجود باید پیش از استفاده از الگو ثبت شوند. افزودن ماده، موجودی انبار ایجاد نمی‌کند.
